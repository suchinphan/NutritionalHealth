print("RUNNING NEW QUALITY AFTER FILE")
...
print("=== DATA QUALITY ASSESSMENT (AFTER CLEANSING) ===")
...
try:
    ...
    if not os.path.exists(INPUT_FILE):
        raise FileNotFoundError("cleansed_data.csv not found. Run 03_cleansing.py first.")

    print("Reading cleansed file:", INPUT_FILE)
