                          ...
                          : () async {
                              ...
                              if (uname.isNotEmpty || pwd.isNotEmpty) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'กรุณาล้างช่องชื่อผู้ใช้และรหัสผ่านก่อนเข้าสู่ระบบแบบผู้เยี่ยมชม',
                                    ),
                                  ),
                                );
                                return;
                              ...
                              try {
                                ...
                                messenger.showSnackBar(
                                  const SnackBar(
                                    content: Text('เข้าสู่ระบบแบบผู้เยี่ยมชม'),
                                  ),
                                );
                                ...
                                messenger.showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'เกิดข้อผิดพลาดขณะเปิดใช้งานโหมดผู้เยี่ยมชม',
                                    ),
                                  ),
                                );
                              }
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            if (resp.statusCode == 200) {
                              ...
                              final token =
                                  j['password_token'] as String? ??
                                  j['authToken'] as String?;
                              if (token != null) {
                              ...
                              messenger.showSnackBar(
                                const SnackBar(
                                  content: Text('เข้าสู่ระบบเรียบร้อย'),
                                ),
                              );
                              setState(() => _loading = false);
                              navigator.pushAndRemoveUntil(
                            ...
                            messenger.showSnackBar(
                              const SnackBar(
                                content: Text('ไม่สามารถติดต่อเซิร์ฟเวอร์ได้'),
                              ),
                            );
                          }
                        },
