...
class _ChooseYourMealAndDurationPageState
  ...
  Future<void> _saveAndCalculate() async {
    ...
    final auth = _auth;
    final personal = auth.user ?? auth.tempPersonal ?? auth.guestPersonal ?? {};
    final hasPersonal = (personal['gender'] != null && personal['age'] != null && personal['weight'] != null && personal['height'] != null) || auth.tempPersonal != null;

    if (!hasPersonal || widget.selectedType.isEmpty || selectedMeal == null || selectedDuration == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('กรุณากรอกข้อมูลส่วนตัว เลือกประเภทอาหาร มื้ออาหาร และระยะเวลาก่อน')),
      );
      return;
    }
    ...
    // persist temporary selections for downstream pages
    _auth.setTempSelections({
      'food_type': widget.selectedType,
      'category': widget.selectedCategory,
      'menu': widget.selectedMenu,
      'dessert': widget.selectedDessert,
      'drink_type': widget.selectedDrinkType,
      'drink_menu': widget.selectedDrinkMenu,
      'meal': meal,
      'duration': duration,
    });
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: (_saving || !_canProceed()) ? null : _saveAndCalculate,
  ...
  bool _canProceed() {
    final personal = _auth.user ?? _auth.tempPersonal ?? _auth.guestPersonal ?? {};
    final hasPersonal = (personal['gender'] != null && personal['age'] != null && personal['weight'] != null && personal['height'] != null) || _auth.tempPersonal != null;
    final hasType = widget.selectedType.isNotEmpty;
    final hasMeal = selectedMeal != null;
    final hasDuration = selectedDuration != null;
    return hasPersonal && hasType && hasMeal && hasDuration;
  }
