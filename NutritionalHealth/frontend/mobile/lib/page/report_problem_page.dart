                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Checkbox(
                            value: _systemIssue,
                            onChanged: AuthService().isGuestLocked
                                ? null
                                : (v) =>
                                      setState(() => _systemIssue = v ?? false),
                          ),
                                ...
                                : () async {
                                    ...
                                    if (!_systemIssue &&
                                      ...
                                      messenger.showSnackBar(
                                        const SnackBar(
                                          content: Text(
                                            'กรุณาเลือกประเภทหรือกรอกรายละเอียด',
                                          ),
                                        ),
                                      );
                                      return;
                                    ...
                                    final type = _systemIssue
                                        ? 'system'
                                        : (_userIssue ? 'user' : 'other');
